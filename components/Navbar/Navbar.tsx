          ...
          <ul className={`flex-col md:flex-row md:flex space-y-4 md:space-y-0 md:space-x-8 items-start md:items-center absolute md:static bg-gray-800 left-0 w-full md:w-auto px-4 md:px-0 py-4 md:py-0 z-50 transition-all duration-300 ${isOpen ? "top-16" : "-top-[1000px]"}`}>
            <li>
              <Link href="/"
                ...
                className={`px-4 py-2 rounded-md font-semibold transition ${hoveredItems.includes("home")
                    ? "bg-white text-black"
            ...
            <li><DropDownServices /></li>
              ...
              <Link href="/tarrif"
                ...
                className={`px-4 py-2 rounded-md font-semibold transition ${hoveredItems.includes("tarrif")
                    ? "bg-white text-black"
                    : "hover:bg-white hover:text-black"
                  }`}
              >
            ...
            <li><DropDownAssociates /></li>
             <li>
              <Link href="/gallery"
                ...
                className={`px-4 py-2 rounded-md font-semibold transition ${hoveredItems.includes("gallery")
                    ? "bg-white text-black"
                    : "hover:bg-white hover:text-black"
                  }`}
              >
             ...
             <li>
              <Link href="/contact"
                ...
                className={`px-4 py-2 rounded-md font-semibold transition ${hoveredItems.includes("contact")
                    ? "bg-white text-black"
                    : "hover:bg-white hover:text-black"
                  }`}
              >
             ...
             <li>
              <Link href="/newevents"
                ...
                className={`px-4 py-2 rounded-md font-semibold transition ${hoveredItems.includes("newevents")
                    ? "bg-white text-black"
                    : "hover:bg-white hover:text-black"
                  }`}
              >
            ...
            <li>
              <Link href="/csr"
                ...
                className={`px-4 py-2 rounded-md font-semibold transition ${hoveredItems.includes("csr")
                    ? "bg-white text-black"
                    : "hover:bg-white hover:text-black"
                  }`}
              >
